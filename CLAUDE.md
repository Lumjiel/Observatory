...
### 移动端导航
- 底部导航补全 8 个视图（log/dashboard/errors/milestones/projects/skills/about/help）
- `errors` 视图显示分类文章（reading/essays 分离为独立分类）
...
### 分类页合并
- 4 个静态分类页（tech/reading/projects/essays）合并为 `articles.njk` 的 query param 路由
