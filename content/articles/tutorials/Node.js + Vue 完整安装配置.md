...
#### 步骤 3：验证配置是否成功
![(Pasted_image_20260109173458.png)](/img/2026/Node.js + Vue 完整安装配置/Pasted_image_20260109173458.png)
...
![(Pasted_image_20260109173544.png)](/img/2026/Node.js + Vue 完整安装配置/Pasted_image_20260109173544.png)
...
4. 点击 “新建”，添加两个路径（和你创建的目录一致）：
    ...
    - `D:\Program Files\nodejs\node_cache`
5. 点击 “确定” 保存。
![(Pasted_image_20260109173642.png)](/img/2026/Node.js + Vue 完整安装配置/Pasted_image_20260109173642.png)
#### 步骤 2：配置 “系统变量”（所有用户生效）

1. 在 “系统变量” 栏（下半部分）点击 “新建”；
2. 变量名：`NODE_PATH`，变量值：`D:\Program Files\nodejs\node_global\node_modules`（全局包的模块目录）；
![(Pasted_image_20260109173707.png)](/img/2026/Node.js + Vue 完整安装配置/Pasted_image_20260109173707.png)
3. 找到系统变量中的 “Path”，双击编辑；
4. 点击 “新建”，添加 Node.js 安装路径：`D:\Program Files\nodejs`（就是你安装 Node.js 时的路径）；或==％NODE_PATH%==
![(Pasted_image_20260109173727.png)](/img/2026/Node.js + Vue 完整安装配置/Pasted_image_20260109173727.png)
...
![(Pasted_image_20260109173912.png)](/img/2026/Node.js + Vue 完整安装配置/Pasted_image_20260109173912.png)
### 2. 安装 webpack（打包工具）
